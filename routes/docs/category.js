...
module.exports = (req, res, next) => {
  if (i18n.electronSupportedVersions.includes(req.params.category) && !req.params.versionedCategory) {
  ...
  const category = req.params.versionedCategory ? req.params.versionedCategory : req.params.category
